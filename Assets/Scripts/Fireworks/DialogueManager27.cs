...
public class DialogueManager27 : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.FireworkDialogue1 == true && StateNameController.FireworkDialogue1Started == false)
        {
            FindObjectOfType<AudioManager>().Stop("Theme");
            FindObjectOfType<AudioManager>().Play("BackgroundExplosion");
            StartDialogue(dialogue[i]);
            StateNameController.FireworkDialogue1 = false;
            StateNameController.FireworkDialogue1Started = true;
        }
    }
