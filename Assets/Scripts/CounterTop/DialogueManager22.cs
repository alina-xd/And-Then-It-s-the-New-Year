...
public class DialogueManager22 : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.CounterTopDialogue4 == true && StateNameController.CounterTopDialogue4Started == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.CanMove = false;
            StateNameController.CounterTopDialogue4 = false;
            StateNameController.CounterTopDialogue4Started = true;
        }
    }
    ...
    void EndDialogue()
    {
        ...
        else if (i == total - 1)
        {
            ...
            CookingManager.CanDragFillings = true;
        }
    }
}
