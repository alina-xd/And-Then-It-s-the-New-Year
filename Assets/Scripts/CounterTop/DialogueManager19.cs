...
public class DialogueManager19 : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.CounterTopDialogue1 == true && StateNameController.CounterTopDialogue1Started == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.CanMove = false;
            StateNameController.CounterTopDialogue1 = false;
            StateNameController.CounterTopDialogue1Started = true;
        }
    }
    ...
    void EndDialogue()
    {
        ...
        else if (i == total - 1)
        {
            ...
            CookingManager.CanDragWater = true;
        }
    }
}
