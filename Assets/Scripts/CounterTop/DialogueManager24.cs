...
public class DialogueManager24 : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.CounterTopDialogue6 == true && StateNameController.CounterTopDialogue6Started == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.CanMove = false;
            StateNameController.CounterTopDialogue6 = false;
            StateNameController.CounterTopDialogue6Started = true;
        }
    }
    ...
    void EndDialogue()
    {
        ...
        else if (i == total - 1)
        {
            ...
            StateNameController.NoteLength = 8;
            FindObjectOfType<FadeInOut>().Load("DinnerTable");
