...
public class DialogueManager21 : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.CounterTopDialogue3 == true && StateNameController.CounterTopDialogue3Started == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.CanMove = false;
            StateNameController.CounterTopDialogue3 = false;
            StateNameController.CounterTopDialogue3Started = true;
        }
    }
    ...
    void EndDialogue()
    {
        ...
        else if (i == total - 1)
        {
            ...
            CookingManager.CanDragRollingPin = true;
        }
    }
}
