...
public class DialogueManager20 : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.CounterTopDialogue2 == true && StateNameController.CounterTopDialogue2Started == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.CanMove = false;
            StateNameController.CounterTopDialogue2 = false;
            StateNameController.CounterTopDialogue2Started = true;
        }
    }
    ...
    void EndDialogue()
    {
        ...
        else if (i == total - 1)
        {
            ...
            CookingManager.CanClickDough = true;
        }
    }
}
