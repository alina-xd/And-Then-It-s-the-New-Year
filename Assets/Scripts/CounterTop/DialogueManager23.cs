...
public class DialogueManager23 : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.CounterTopDialogue5 == true && StateNameController.CounterTopDialogue5Started == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.CanMove = false;
            StateNameController.CounterTopDialogue5 = false;
            StateNameController.CounterTopDialogue5Started = true;
        }
    }
    ...
    void EndDialogue()
    {
        ...
        else if (i == total - 1)
        {
            ...
            CookingManager.CanClickFillings = true;
        }
    }
}
