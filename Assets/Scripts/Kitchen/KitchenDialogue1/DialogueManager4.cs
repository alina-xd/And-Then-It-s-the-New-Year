...
{
    //public DialogueEtName dialogue;
    //public DialogueEtName dialogue2;
    ...
    void Update()
    {
        if (StateNameController.KitchenDialogue1 == true && StateNameController.KitchenDialogue1Started == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.CanMove = false;
            StateNameController.KitchenDialogue1 = false;
        }
    }
