...
public class DialogueManager14 : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.StreetDialogue2 == true && StateNameController.StreetDialogue2Started == false
            &&StateNameController.DialogueRunning == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.DialogueRunning = true;
            StateNameController.CanMove = false;
            StateNameController.StreetDialogue2 = false;
            StateNameController.StreetDialogue2Started = true;
        }
    }
    ...
    void EndDialogue()
    {
        ...
        else if (i == total - 1)
        {
            ...
            StateNameController.DialogueRunning = false;
            StateNameController.NoteLength = 6;
            FindObjectOfType<FadeInOut>().Load("LionDance");
