...
public class DialogueManager13 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (StateNameController.StreetDialogue1 == true && StateNameController.StreetDialogue1Started == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.DialogueRunning = true;
            StateNameController.CanMove = false;
            StateNameController.StreetDialogue1 = false;
            StateNameController.StreetDialogue1Started = true;
        }
    }
