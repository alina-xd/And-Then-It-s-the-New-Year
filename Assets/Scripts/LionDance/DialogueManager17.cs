...
public class DialogueManager17 : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.LionDanceDialogue3 == true && StateNameController.LionDanceDialogue3Started == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.LionCanMove = false;
            StateNameController.LionDanceDialogue3 = false;
            StateNameController.LionDanceDialogue3Started = true;
        }
    }
