...
public class DialogueManager6 : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.LivingRoomDialogue3 == true && StateNameController.LivingRoomDialogue3Started == false)
        {
            StateNameController.DaddyAppears = true;
            StartDialogue(dialogue[i]);
            StateNameController.CanMove = false;
            StateNameController.LivingRoomDialogue3 = false;
        }
    }
    ...
    void EndDialogue()
    {
        ...
        else if (i == total - 1)
        {
            ...
            StateNameController.LivingRoomDialogue3Started = true;
        }
    }
}
