...
public class GrandmaDialogue : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.GrandmaDialogue == true && StateNameController.GrandmaDialogueStarted == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.CanMove = false;
            StateNameController.GrandmaDialogue = false;
        }
    }
    ...
    void EndDialogue()
    {
        ...
        else if (i == total - 1)
        {
            ...
            StateNameController.GrandmaDialogueStarted = true;
        }
    }
}
