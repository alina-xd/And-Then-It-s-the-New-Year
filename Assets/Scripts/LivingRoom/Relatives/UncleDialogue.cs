...
public class UncleDialogue : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.UncleDialogue == true && StateNameController.UncleDialogueStarted == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.CanMove = false;
            StateNameController.UncleDialogue = false;
        }
    }
    ...
    void EndDialogue()
    {
        ...
        else if (i == total - 1)
        {
            ...
            StateNameController.UncleDialogueStarted = true;
        }
    }
}
