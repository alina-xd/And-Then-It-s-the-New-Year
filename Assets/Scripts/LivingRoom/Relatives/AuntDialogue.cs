...
public class AuntDialogue : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.AuntDialogue == true && StateNameController.AuntDialogueStarted == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.CanMove = false;
            StateNameController.AuntDialogue = false;
        }
    }
    ...
    void EndDialogue()
    {
        ...
        else if (i == total - 1)
        {
            ...
            StateNameController.AuntDialogueStarted = true;
        }
    }
}
