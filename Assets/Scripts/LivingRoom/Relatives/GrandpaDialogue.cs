...
public class GrandpaDialogue : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.GrandpaDialogue == true && StateNameController.GrandpaDialogueStarted == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.CanMove = false;
            StateNameController.GrandpaDialogue = false;
        }
    }
    ...
    void EndDialogue()
    {
        ...
        else if (i == total - 1)
        {
            ...
            StateNameController.GrandpaDialogueStarted = true;
        }
    }
}
