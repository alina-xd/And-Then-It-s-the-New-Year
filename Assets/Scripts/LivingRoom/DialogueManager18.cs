...
public class DialogueManager18 : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.LivingRoomDialogue7 == true && StateNameController.LivingRoomDialogue7Started == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.CanMove = false;
            StateNameController.LivingRoomDialogue7 = false;
            StateNameController.LivingRoomDialogue7Started = true;
        }
    }
    ...
    void EndDialogue()
    {
        ...
        else if (i == total - 1)
        {
            ...
            StateNameController.NoteLength = 7;
            FindObjectOfType<FadeInOut>().Load("CounterTop");
