...
public class DialogueManager12 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (StateNameController.LivingRoomDialogue6 == true && StateNameController.LivingRoomDialogue6Started == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.CanMove = false;
            StateNameController.LivingRoomDialogue6 = false;
            StateNameController.LivingRoomDialogue6Started = true;
        }
    }
    ...
    void EndDialogue()
    {
        ...
        else if (i == total - 1)
        {
            ...
            FindObjectOfType<FadeInOut>().Load("Street");
        }
    }
}
