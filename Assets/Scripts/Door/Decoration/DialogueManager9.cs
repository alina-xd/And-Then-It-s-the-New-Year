...
public class DialogueManager9 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        i = 0;
        back.onClick.AddListener(NextDialogue);
    }

    void Update()
    {
        if (StateNameController.DoorDialogue2 == true && StateNameController.DoorDialogue2Started == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.DoorDialogue2 = false;
            StateNameController.DoorDialogue2Started = true;
        }
    }
    ...
    {
        FindObjectOfType<FadeInOut>().Load("DoorOpen");
    }
}