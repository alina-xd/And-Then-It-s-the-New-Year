...
public class DialogueManager10 : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.DoorDialogue3 == true && StateNameController.DoorDialogue3Started == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.DoorDialogue3 = false;
            StateNameController.DoorDialogue3Started = true;
        }
    }
    ...
    void EndDialogue()
    {
        ...
        else if (i == total - 1)
        {
            ...
            StateNameController.LivingRoomDialogue5 = true;
            StateNameController.NoteLength = 5;
            FindObjectOfType<FadeInOut>().Load("LivingRoom2");
