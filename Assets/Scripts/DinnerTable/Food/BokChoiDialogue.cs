...
public class BokChoiDialogue : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.BokChoiDialogue == true && StateNameController.BokChoiDialogueStarted == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.BokChoiDialogue = false;
            StateNameController.BokChoiDialogueStarted = true;
