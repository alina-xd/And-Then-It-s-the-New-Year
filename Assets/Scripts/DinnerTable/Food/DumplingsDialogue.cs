...
public class DumplingsDialogue : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.DumplingsDialogue == true && StateNameController.DumplingsDialogueStarted == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.DumplingsDialogue = false;
            StateNameController.DumplingsDialogueStarted = true;
