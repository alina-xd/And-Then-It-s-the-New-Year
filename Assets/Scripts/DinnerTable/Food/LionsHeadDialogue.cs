...
public class LionsHeadDialogue : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.LionsHeadDialogue == true && StateNameController.LionsHeadDialogueStarted == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.LionsHeadDialogue = false;
            StateNameController.LionsHeadDialogueStarted = true;
