...
public class DongpoRouDialogue : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.DongpoRouDialogue == true && StateNameController.DongpoRouDialogueStarted == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.DongpoRouDialogue = false;
            StateNameController.DongpoRouDialogueStarted = true;
