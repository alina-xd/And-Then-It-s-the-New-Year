...
public class MapoTofuDialogue : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.MapoTofuDialogue == true && StateNameController.MapoTofuDialogueStarted == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.MapoTofuDialogue = false;
            StateNameController.MapoTofuDialogueStarted = true;
