...
public class PekingDuckDialogue : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.PekingDuckDialogue == true && StateNameController.PekingDuckDialogueStarted == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.PekingDuckDialogue = false;
            StateNameController.PekingDuckDialogueStarted = true;
            FoodManager.CanClickFood = false;
        }
    }
