...
public class FishDialogue : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.FishDialogue == true && StateNameController.FishDialogueStarted == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.FishDialogue = false;
            StateNameController.FishDialogueStarted = true;
