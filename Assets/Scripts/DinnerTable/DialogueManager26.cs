...
public class DialogueManager26 : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.DinnerDialogue2 == true && StateNameController.DinnerDialogue2Started == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.NoteLength = 9;
            FindObjectOfType<AudioManager>().Play("NewNote");
            StateNameController.DinnerDialogue2 = false;
            StateNameController.DinnerDialogue2Started = true;
        }
    }
    ...
    void EndDialogue()
    {
        ...
        else if (i == total - 1)
        {
            ...
            StateNameController.NoteLength = 10;
            FindObjectOfType<FadeInOut>().Load("FireWorks");
            FindObjectOfType<AudioManager>().Play("NewNote");
        }
    }
}
