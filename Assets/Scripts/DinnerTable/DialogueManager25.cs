...
public class DialogueManager25 : MonoBehaviour
{
    ...
    void Update()
    {
        if (StateNameController.DinnerDialogue1 == true && StateNameController.DinnerDialogue1Started == false)
        {
            StartDialogue(dialogue[i]);
            StateNameController.DinnerDialogue1 = false;
            StateNameController.DinnerDialogue1Started = true;
        }
    }
